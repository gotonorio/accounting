...
SECRET_KEY = 'pd!8__a5-muyqsip7zfbn1tf^g2j-+1byzv#1orv23+6c+il&v'
...
INSTALLED_APPS = [
    ...
    'asset_list.apps.AssetListConfig',
    'kanrihi_in.apps.KanrihiInConfig',
    'kanrihi_out.apps.KanrihiOutConfig',
    'shuuzenhi_in.apps.ShuuzenhiInConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounting.context_processors.version_no',
            ],
            'libraries':{
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'ac3.sqlite3'),
    }
}
