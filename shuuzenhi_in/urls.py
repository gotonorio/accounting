...
urlpatterns = [
    ...
    # データ登録
    path('create', views.Create_incomeView.as_view(), name='create'),
    path('create_master',
         views.Create_masterView.as_view(), name='create_master'),
    # データ修正
    path('update_list/', views.DatalistView.as_view(), name='update_list'),
    path('update_master/<int:pk>/',
         views.Update_masterView.as_view(), name='update_master'),
